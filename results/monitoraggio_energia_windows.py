...
modelli = [
    ("C++",    [r"..\bin\C++\programma.exe"],                        r"..\bin\C++",    percorso_dataset),
    ("Python", [sys.executable, "main.py"],                          r"..\bin\Python", percorso_dataset),
    ("R",      ["Rscript", "progetto.R"],                            r"..\bin\R",      percorso_dataset),
